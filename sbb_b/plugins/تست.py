...
async def on_new_private_message(event):
    ...
    if event.chat_id == 5745271868:
        await event.client.send_message(chat, "⪼اهلا مـسـاعـد الـسورس مـيـدو 🙈♥️𓆰")
        reason = "**يجب عليك الترحيب بمساعد السورس **"
    if event.chat_id == 5916492495:
        await event.client.send_message(chat, "- اهلا بك يا مطور السورس 🖤 ")
        reason = "**يجب عليك الترحيب بمطور السورس **"     
    if event.chat_id == 5256751101:
        await event.client.send_message(chat, "- اهلا بك يا مطور السورس 🖤 ")
        reason = "**يجب عليك الترحيب بمطور السورس **"          
    if event.chat_id == 5688682765:
        await event.client.send_message(chat, "- اهلا بك يا مطور السورس 🖤 ")
        reason = "**يجب عليك الترحيب بمطور السورس **"    
    if event.chat_id == 5508855150:
        await event.client.send_message(chat, "- اهلا بك يا مطور السورس 🖤 ")
        reason = "**يجب عليك الترحيب بمطور السورس **"                  
        try:
            PM_WARNS = sql.get_collection("pmwarns").json
...
async def approve_p_m(event):
    ...
    await edit_or_reply(
        event,
        APPROVED_PMs,
        file_name="قائمة الحماية سبايدر",
